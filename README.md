<section class="about-series" style="max-width: 900px; margin: auto; padding: 60px 20px; font-family: 'Poppins', sans-serif; color: #fff; background: linear-gradient(to bottom, #d700b5, #ff79f2); border-radius: 20px;">
